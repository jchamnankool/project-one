...
u1 = User.create :name => "A", :email => "a@ga.co", :password => "chicken"
u2 = User.create :name => "B", :email => "b@ga.co", :password => "chicken"
u3 = User.create :name => "C", :email => "c@ga.co", :password => "chicken"
u4 = User.create :name => "D", :email => "d@ga.co", :password => "chicken"
u5 = User.create :name => "E", :email => "e@ga.co", :password => "chicken"
u6 = User.create :name => "F", :email => "f@ga.co", :password => "chicken"
u7 = User.create :name => "G", :email => "g@ga.co", :password => "chicken"
u8 = User.create :name => "H", :email => "h@ga.co", :password => "chicken"
u9 = User.create :name => "I", :email => "i@ga.co", :password => "chicken"
